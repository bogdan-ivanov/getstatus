"""
Django settings for getstatus project.
...
SECRET_KEY = '$bhp4jwl(i#z!j-_oa^29&e5y7(^heerks8vdr=(2g3$=oh%j8'
...
WSGI_APPLICATION = 'getstatus.wsgi.application'
